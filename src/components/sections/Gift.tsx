...
export default function Gift() {
  ...
  // Pastikan gifts selalu array yang valid
  const gifts = Array.isArray(mergedData?.gifts) ? mergedData.gifts : [];
  const giftAddress = mergedData?.giftAddress || WEDDING.giftAddress;
    ...
    <section id="kado" className="relative z-10 py-24 sm:py-32">
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        <SectionHead
          ...
          title={
            <>
              {t.gift.mostBeautifulGift.split(" ")[0]}{" "}
              <em className="italic text-gold-300">
                {t.gift.mostBeautifulGift.split(" ").slice(1).join(" ")}
              </em>
            </>
          }
          sub={t.gift.subtitle}
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {gifts.map((g, i) => (
            ...
            >
              ...
              {/* Header: icon + nama bank + atas nama */}
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-[13px] text-sage-300/80">
                    a.n. {g.holder || "-"}
                  </p>
                </div>
              </div>
        ...
        {/* Alamat hadiah fisik */}
        <div className="mt-6 flex flex-col items-center gap-5 border border-gold-500/20 bg-pine-800/50 p-7 text-center transition-colors duration-500 hover:border-gold-500/50 sm:flex-row sm:text-left">
